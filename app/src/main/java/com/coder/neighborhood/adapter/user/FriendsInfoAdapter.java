...
import com.coder.neighborhood.adapter.circle.CircleCommentAdapter;
...
public class FriendsInfoAdapter extends RvAdapter<CircleBean> {
    ...
    class GoodFriendsViewHolder extends RvViewHolder<CircleBean> {
        ...
        public void onBindData(int position, CircleBean bean) {
            ...
            if (!TextUtils.isEmpty(bean.getCircleDate())) {
                tvSubScribe.setText(TimeUtils.milliseconds2String(Long.parseLong(bean
                        .getCircleDate()), new SimpleDateFormat("yyyy.MM.dd")));
            }
